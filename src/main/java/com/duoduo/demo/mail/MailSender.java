...
public class MailSender {
	...
	private static final String MAIL_SERVER_HOST = "10.5.0.62"; // " smtp.163.com "
	private static final String MAIL_SERVER_USERNAME = "kdvp";
	private static final String MAIL_SERVER_PASSWORD = "kdvp888";
	private static final String MAIL_SERVER_AUTH = "true";
	private static final String MAIL_SERVER_TIMEOUT = "8000";

	private static final String MAIL_FROM = "致友小秘书 <kdvp@kedacom.com>"; // 注意邮箱要和登录的一致，否则可能会因为安全问题被拦截
	private static final String MAIL_TO = "矿泉水 <chengesheng@kedacom.com>";
	private static final String MAIL_FROM_MAIL = "kdvp@kedacom.com";
