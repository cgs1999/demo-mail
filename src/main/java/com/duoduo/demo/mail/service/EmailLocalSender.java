...
@Service("emailLocalSender")
public class EmailLocalSender {
	...
	private static final String MAIL_PASSWORD = "Cgs810503";
	...
	public static void main(String[] args) {
		...
		try {
			EmailLocalSender emailLocalSender = new EmailLocalSender();
